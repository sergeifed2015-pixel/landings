...
**Логотип** — знак-«веха»: путевой маркер (флажок на шесте) в фирменном зелёном, с охряным вымпелом. Отражает название и идею ориентира на пути к списанию долга. SVG в шапке сайта и как `favicon.svg`.
...
**Логотип** — кофейная ягода (вишня) в вишнёво-красном с фисташковым листом и стеблем, бликом и лёгким швом-зерном. Обыгрывает название и то, что кофе — это ягода, а не порошок. SVG в шапке, в прелоадере и как `favicon.svg`.
...
```
.
├── index.html        витрина со ссылками на оба лендинга
