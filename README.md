...
| **ЗЕНИТ** | Планетарий и обсерватория: звёздное небо, фаза Луны, калькулятор билетов, Москва | [zenit/](https://sergeifed2015-pixel.github.io/landings/zenit/) |
...
<table>
  ...
  <tr>
    ...
    <td valign="top"><b>Что интерактивного</b><br/><sub>Разделы переключаются как вкладки-панели (по одной на экране), видеофон, мобильное меню, живое подчёркивание навигации, вкладки внутри секций, кнопки «Выбрать» подставляют программу в форму, отправка → экран подтверждения со сводкой, FAQ-аккордеон.</sub></td>
  </tr>
</table>

### Возможности

- **Навигация как вкладки** — разделы (Главная / Курсы / Расписание / Тренеры / Цены / Контакты) открываются как панели по одной на экране, без длинной прокрутки — так же, как в «Веха» и «ЯГОДА». У каждой панели внизу ссылка «Дальше» на следующий раздел, поддержаны стрелки клавиатуры и адрес `#раздел`.
...
- **Вкладки внутри секций** — три уровня курсов (Новичок / Продолжающий / Про), у каждого свои программы: разовые занятия, курсы, интенсивы, детская группа, кемп, surf-guiding.
...
## <img src="zenit/favicon.svg" width="26" align="top"/> ЗЕНИТ — планетарий и обсерватория

> Купольные шоу в 4K, наблюдения в настоящий телескоп и лекции астрономов. Сеансы каждый день. Москва.

**[→ Открыть сайт](https://sergeifed2015-pixel.github.io/landings/zenit/)**

**Логотип** — четырёхлучевая звезда-искра (зенит = точка над головой) в бирюзовом с маленькой золотой звёздочкой-спутником. SVG в шапке и как `favicon.svg`.

### Скриншоты

<table>
  <tr>
    <td><img src="assets/zenit-hero.png" alt="Главный экран ЗЕНИТ" width="440"/><br/><sub>Живое звёздное небо, созвездие и виджет «Небо сегодня» с фазой Луны</sub></td>
    <td><img src="assets/zenit-programs.png" alt="Программы" width="440"/><br/><sub>Афиша с вкладками: купольные шоу, наблюдения, детям, лекции</sub></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><img src="assets/zenit-tickets.png" alt="Калькулятор билетов" width="720"/><br/><sub>Калькулятор билетов: программа, сеанс, счётчики билетов и живая сумма → экран брони</sub></td>
  </tr>
</table>

### Возможности

- **Живое звёздное небо** — анимированное поле звёзд на `<canvas>` с мерцанием, разноцветными звёздами и редкими метеорами; статично при `prefers-reduced-motion`.
- **Виджет «Небо сегодня»** — фаза Луны считается от **реальной текущей даты** (синодический месяц), с названием фазы, процентом освещённости и нарисованным диском Луны; плюс созвездие в hero.
- **Вкладки программ** — купольные шоу / наблюдения / детям / лекции, у каждой карточки возраст, длительность и цена.
- **Вкладки расписания** — Сегодня / Завтра / Выходные с сеансами, залами и статусом мест.
- **Калькулятор билетов** — выбор программы, даты и сеанса, счётчики трёх типов билетов (взрослый / детский / льготный) с живым пересчётом суммы; кнопки «Взять билет» подставляют программу.
- **Экран брони** — валидация (минимум один билет) и подтверждение с полной раскладкой по типам билетов и итогом.
- **Абонементы** — три тарифа; **FAQ**-аккордеон; плавная навигация со скролл-спаем и подсветкой активного раздела; **мобильное меню**; появление секций при прокрутке.

**Контакты на сайте:** Москва, Садовая-Кудринская, 5 · Вт–Вс 10:00–22:00 · тел. +7 495 000-00-00 · Telegram @zenit_sky.
...
├── zenit/index.html  лендинг планетария (звёздное небо, калькулятор билетов)
